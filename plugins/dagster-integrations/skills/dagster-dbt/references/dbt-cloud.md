...
The dagster-dbt library provides integration with dbt Cloud via the v2 API (recommended) for projects hosted on dbt Cloud.
...
For dbt Core projects (self-hosted), use the [Component-Based](component-based-integration.md) or [Pythonic](pythonic-integration.md) integration instead.
